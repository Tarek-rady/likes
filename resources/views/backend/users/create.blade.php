@extends('layouts.master')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('users.store') }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" >
            @csrf
            ...
            <div class="row">
                ...
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="number"  name="mobile" class="form-control form-control-solid" placeholder="Enter Your Mobile" >
